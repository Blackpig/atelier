...
class BlockHeroConversion extends BaseConversion
{
    ...
    /**
     * Include social media conversions
     * Hero images are often used for social sharing
     */
    protected function includes(): array
    {
        return [
            SocialImageConversion::class,
        ];
    }
    ...
    public function getResponsiveConfig(): array
    {
        return [
            ...
            // Srcset configuration (display conversions only)
            'srcset' => [
                'thumb' => true,
                'medium' => true,
                'large' => true,
                ...
                'og' => false, // Social media only
                'twitter' => false, // Social media only
            ],
